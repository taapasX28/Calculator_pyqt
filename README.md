...
[![LICENSE](https://img.shields.io/badge/license-MIT-lightgrey.svg)](https://github.com/taapas1128/Calculator_pyqt/blob/master/LICENSE)
...
* Using the complex mode :
  There is a button labelled "complex" in the upper right corner of the calculator. Press it to enter the complex mode. Here   you can perform operations on complex numbers. Imaginary numbers are represented in A + Bj format. After giving a proper input you can perform all operations       such as addition, subtraction, multiplication, division and exponents. You can also find argument of the complex number       by pressing the "Arg" button. You can switch back to normal mode by pressing the "complex" button again.
...
For any queries, please raise an issue or contact github @taapasX28.
